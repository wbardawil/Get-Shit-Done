...
const NAV_ITEMS = [
  ...
  { href: "/assess", label: "Assess", icon: "clipboard" },
  { href: "/opi", label: "OPI", icon: "bar-chart" },
  { href: "/portfolio", label: "Portfolio", icon: "target" },
  { href: "/execute", label: "Execute", icon: "kanban" },
  ...
  return (
    <aside className="flex flex-col w-64 border-r border-border bg-card h-full">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-border">
        ...
        <div>
          <h1 className="font-semibold text-sm text-foreground">BDS OS</h1>
      ...
      <div className="px-6 py-4 border-t border-border">
        <p className="text-xs text-muted-foreground">BDS OS v2.0</p>
      </div>
    </aside>
  );
}
